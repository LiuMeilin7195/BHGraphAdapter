...
imagenet_classes = ["tench", "goldfish", "great white shark", "tiger shark", "hammerhead shark", "electric ray", "stingray", "rooster", "hen", "ostrich", 
                    ...
                    "American dipper", "kite (bird of prey)", "bald eagle", "vulture", "great grey owl", "fire salamander", "smooth newt", "newt", "spotted salamander", "axolotl", 
                    ...
                    "night snake", "boa constrictor", "African rock python", "Indian cobra", "green mamba", "sea snake", "Saharan horned viper", "eastern diamondback rattlesnake", "sidewinder rattlesnake", "trilobite", 
                    ...
                    "black grouse", "ptarmigan", "ruffed grouse", "prairie grouse", "peafowl", "quail", "partridge", "african grey parrot", "macaw", "sulphur-crested cockatoo", 
...
class ImageNet():
    ...
    # def __init__(self, root, num_shots, preprocess, test_on_v2=False, v2_path=None):
    # def __init__(self, root, num_shots, preprocess, test_on_sketch=False,  sketch_path=None):
    def __init__(self, root, num_shots, preprocess):
        ...
        # if test_on_v2 and v2_path:
        #     # 使用ImageNetV2作为测试集
        #     self.val = ImageNetV2(v2_path, transform=test_preprocess)
        #     self.test = ImageNetV2(v2_path, transform=test_preprocess)
        # if test_on_sketch and sketch_path:
        #     print("Using ImageNet-Sketch as test set")
        #     self.val = ImageNetSketch(sketch_path, transform=test_preprocess)
        #     self.test = ImageNetSketch(sketch_path, transform=test_preprocess)
        # else:
        #     # 使用原始ImageNet验证集
        ...
        self.val = torchvision.datasets.ImageNet(self.image_dir, split='val', transform=test_preprocess)
        self.test = torchvision.datasets.ImageNet(self.image_dir, split='val', transform=test_preprocess)
        # self.test = ImageNetTestDataset(self.image_dir, split='val', transform=preprocess)
...
if __name__ == '__main__':
    print('screw' in imagenet_classes)